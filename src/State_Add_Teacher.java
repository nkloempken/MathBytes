...
public class State_Add_Teacher extends State{
     ...
     */
    public State_Add_Teacher(Game game,CurrentAdminData data) {
        super(game);
    ...
    public void tick() {
        ...
        if(buttons.get(0).checkButtonHovered(game)&&MouseManager.mousePressed){
            ...
            if(userNameEntry.getInputString().length()<5){
                ...
                boolean b = Users.makeNewTeacher(userNameEntry.getInputString(),passWordEntry.getInputString(),fullNameEntry.getInputString(),game,data.username);
                data.teachers.add(Users.loadTeacherData(userNameEntry.getInputString()));
                if (b){
    ...
    private void drawBackground(Graphics g){
        ...
        g.drawString("Enter the teacher's full name",Display.centerString("Enter the teacher's full name",g,game.font60,game),(int)(h*0.22));
        ...
        g.setFont(game.font30);
        g.drawString("Name (EX: Mr. Smith): ",(int)(game.width*0.125),(int)(game.height*0.64));
